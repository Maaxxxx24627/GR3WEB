...
<head>
    ...
    <meta name="description" content="Ceci est la page principale de notre site web regroupant les offres de stages">
...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="poststage">POSTER UN STAGE</a></li>
    ...
    <main>
        <section id="internships">
            <h1>STAGES</h1>
            <div id="search-bar-entreprise">
                <form method="GET">
                    <input type="search" name="entreprise" placeholder="Rechercher une entreprise">
...
<?php if (!empty($offrestage)): ?>
    <?php foreach ($offrestage as $offre): ?>
        <div class="internship-container">
            ...
            <form action="wishlist.view.php" method="post"> 
                <input type="hidden" name="offreTitre" value="<?php echo $offre['Titre']; ?>">
                <input type="hidden" name="nomEntreprise" value="<?php echo $offre['NomEntreprise']; ?>">
                <input type="hidden" name="ville" value="<?php echo $offre['VilleLocalisation']; ?>">
