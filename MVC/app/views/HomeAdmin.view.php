...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a href="gestionAdmin">GESTION</a></li>
                <li><a href="btn_gestion_offreAdmin">POSTER UN STAGE</a></li>
    ...
    <li class="Wish-list">
        <button onclick="window.location.href='wishlistAdmin'">Wishlist</button>
    </li>
    </div>
